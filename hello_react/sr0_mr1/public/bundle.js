...
/***/ function(module, exports, __webpack_require__) {
	...
	var GreeterForm = React.createClass({
	    ...
	    buildStateWith: function buildStateWith(referenceList) {
	        var nameReference = referenceList.name,
	        ...
	        var rtcName = nameValue.length > 0,
	            rtcMessage = messageValue.length > 0;

	        var rtcBoth = rtcName && rtcMessage,
	            state = {};
	    ...
	    onFormSubmit: function onFormSubmit(e) {
	        e.preventDefault();
	        var state = this.buildStateWith(this.refs);
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement('textarea', { ref: 'message', rows: '2' }),
	            React.createElement('br', null),
	            React.createElement(
	                'button',
	                null,
